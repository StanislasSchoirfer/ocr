 ...
 * @return array
 */
function ocr_wp_page_menu_args( $args ) {
	$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'ocr_wp_page_menu_args' );
 ...
 * @return array
 */
function ocr_wp_body_classes( $classes ) {
...
add_filter( 'body_class', 'ocr_wp_body_classes' );
...
add_action( 'wp', 'ocr_wp_setup_author' );

/**
 * Adds a class to the previous post link on single post page
 */
function post_link_attributes_prev($output) {
    $code = 'class="btn btn-danger btn-fab btn-raised mdi-image-navigate-before"';
...
function post_link_attributes_next($output) {
    $code = 'class="btn btn-danger btn-fab btn-raised mdi-image-navigate-next"';
    return str_replace('<a href=', '<a '.$code.' href=', $output);
}
...
function posts_link_attributes_prev() {
    return 'class="btn btn-danger btn-fab btn-raised mdi-image-navigate-before"';
}
...
function posts_link_attributes_next() {
    return 'class="btn btn-danger btn-fab btn-raised mdi-image-navigate-next"';
}
...
function modify_read_more_link() {
	...
	return '<p><a class="read-more" href="' . get_permalink() . '">'.__( 'Lire la suite', 'ocr_wp' ).'</a></p>';
}
